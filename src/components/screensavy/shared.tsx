...
import type { Language, LanguageSetting, MainTranslationKey } from './translations';
...
export const IconButton = ({ icon, onClick, title, active, label }: IconButtonProps) => (
...
export const RgbSlider = ({ channel, value, color, onChange }: RgbSliderProps) => {
...
export const RgbPanel = ({ hexValue, rgb, show, onHexChange, onChannelChange, onCopyHex, copySuccess }: RgbPanelProps) => (
  ...
  return (
    <div className="shades-panel">
      ...
      <div className="shade-container">
        {[shadeSets.baseHexShades, shadeSets.saturationHexShades, shadeSets.adjacentHexShades].map((row, rowIndex) => (
...
export const WelcomeNotification = ({ visible, translation, onClose }: WelcomeNotificationProps) => {
  if (!visible) return null;
...
export const AboutModal = ({ open, languageSetting, detected, translation, onClose }: AboutModalProps) => {
  if (!open) return null;
        ...
        <div className="support-links">
          {SUPPORT_LINKS.map((link) => (
            <a
              ...
              className={link.className ?? `support-button ${link.labelKey}-button`}
            >
